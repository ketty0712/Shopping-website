...
! function(t) {
    ...
    t.fn.Tabledit = function(e) {
                            ...
                            n.each(function() {
                                ...
                                switch (d.columns.editable[e][2]) {
                                    case "textarea":
                                        ...
                                        t.each(d.columns.editable[e][3], function(t, e) {
                                            a += t + '="' + e + '" ';
                                        });
                                        a += 'cols="40" rows="6" class="tabledit-input ' + d.inputClass + '" name="' + d.columns.editable[e][1] + '" style="display: none;" disabled>' + t(this).text() + '</textarea>';
                                        break;
                                    case "select":
                                        // Create select element.
                                        a = '<select class="tabledit-input ' + d.inputClass + '" name="' + d.columns.editable[e][1] + '" style="display: none;" disabled>';

                                        // Create options for select element.
                                        t.each(d.columns.editable[e][3], function(t, e) {
                                            if (n === e) {
                                                a += '<option value="' + t + '" selected>' + e + '</option>';
                                            } else {
                                                a += '<option value="' + t + '">' + e + '</option>';
                                            }
                                        });
                                        ...
                                        break;
                                    case "file":
                                        a = '<input class="tabledit-input ' + d.inputClass + '" type="file" name="' + d.columns.editable[e][1] + '" style="display: none; padding:inherit;" disabled>';
                                        break;
                                    default:
                                        // Create text input element.
                                        if (e == 0) a = '<input class="tabledit-input ' + d.inputClass + '" type="text" name="' + d.columns.editable[e][1] + '" value="' + t(this).text() + '" style="display: none; " disabled>';
                                        else if (e == 1) a = '<input class="col-md-4 tabledit-input ' + d.inputClass + '" type="text" name="' + d.columns.editable[e][1] + '" value="' + t(this).text() + '" style="display: none; " disabled>';
                                        else if (e == 2) a = '<input class="col-md-2 tabledit-input ' + d.inputClass + '" type="text" name="' + d.columns.editable[e][1] + '" value="' + t(this).text() + '" style="display: none; " disabled>';
                                        else
        ...
        return r.columns.identifier(),
            ...
            r.columns.toolbar(),
            d.onDraw(),
            d.deleteButton && (i.on("click", "button.tabledit-delete-button", function(e) {
                if (e.handled !== !0) {
                    e.preventDefault();
            ...
            d.restoreButton && i.on("click", "button.tabledit-restore-button", function(e) { e.handled !== !0 && (e.preventDefault(), c.restore(t(this).parents("td")), e.handled = !0) }),
