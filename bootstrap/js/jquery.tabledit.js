                        ...
                        $td.each(function() {
                            ...
                            switch (settings.columns.editable[i][2]) {
                                case "textarea":
                                    ...
                                    input += 'cols="40" class="tabledit-input ' + settings.inputClass + '" name="' + settings.columns.editable[i][1] + '" style="display: none;" disabled>' + $(this).text() + '</textarea>';
                                    break;
                                case "select":
                                    // Create select element.
                                    ...
                                    break;
                                case "file":
                                    input = '<input class="tabledit-input ' + settings.inputClass + '" type="file" name="' + settings.columns.editable[i][1] + '" style="display: none;" disabled>';
                                    break;
                                default:
                                    // Create text input element.
                                    if (i == 0) input = '<input class="tabledit-input ' + settings.inputClass + '" type="text" name="' + settings.columns.editable[i][1] + '" value="' + $(this).text() + '" style="display: none;" disabled>';
                                    else
                                    if (i == 1) input = '<input class="col-md-4 tabledit-input ' + settings.inputClass + '" type="text" name="' + settings.columns.editable[i][1] + '" value="' + $(this).text() + '" style="display: none;" disabled>';
                                    else if (i == 2) input = '<input class="col-md-2 tabledit-input ' + settings.inputClass + '" type="text" name="' + settings.columns.editable[i][1] + '" value="' + $(this).text() + '" style="display: none;" disabled>';
                                    else
                                    ...
                                    // input += settings.columns.editable[i][2];
                                    break;
                            }
