...
<html>
	<head>
			...
			$(function () {
				...
				$('[name="btn_cart"]').click(function(event){
					...
					$('[name="btn_rem"]').click(function(){
						...
						setTimeout(function(){$('.back_black').css('animation-name','back_black_ani2');},1);
						setTimeout(function(){$('.cart_cover').css('animation-name','cart_cover_ani2');},1);
						setTimeout(function(){$('.cart_big').remove();},300);
                        flag=false;
					});
		...
		<style>
			...
			.cart_title {
			    display: flex;
			    -webkit-box-pack: center; /*div內子元素置中*/
			    justify-content: center;
			    -webkit-box-align: center; /*div內子元素置中*/
		...
		<script type="text/javascript"></script>	<!--表示使用javascript語法	-->
	</head>
	<body>
		...
		<div class='cart_big'>			<!-- 灰黑濾鏡+購物車容器 -->
			<div class='back_black'>	<!-- 灰黑濾鏡 -->
			</div>
			<div tabindex="-1">
				<div class="cart_cover"><!-- 購物車事件觸發容器 -->
					<div class="cart_contant"><!-- 購物車所有物容器 -->
						<div class="cart_title">
							...
							<div class="close_b" name='btn_rem'>
								<svg width="18px" height="18px" viewBox="0 0 26 27" xmlns:xlink="http://www.w3.org/1999/xlink"><title>關閉</title><defs><rect width="39" height="39" rx="5"></rect></defs><g transform="translate(-6 -6)" fill="none" fill-rule="evenodd"><g transform="rotate(135 17.586 18.914)"><rect fill="#000000" y="15.448" width="34" height="4" rx="2"></rect><rect fill="#000000" transform="rotate(90 17 17.448)" y="15.448" width="34" height="4" rx="2"></rect></g></g>
								</svg>
							</div>
						</div>
						<div class="cart_body">
							...
							<div class="cart_item_boxes">
								...
								<div class="items_boxes">
									...
									<div class="smail_title_clear">
										<!-- 小標題與清空案紐 -->
										<h6>商品已加入</h6>
										<h6 tabindex="0" style='cursor:pointer' name="clear_all"><u>清空購物車</u></h6>
									</div>
                                    ...
                                    for ($i = 0; $i < count($_SESSION['cart_id']); $i++) {
										...
										$p_stock=$_SESSION['products']['stock'][$p_id-1];
                                        array_push($arr, $p_id);
													...
													<div class="p_body">
														<div class="quentity">
															...
															<div style="width: 65px;padding:0 10px;">
																...
																<input type="number" name='.$p_id.' style="width: 100%; text-align: center;" value="'.$_SESSION['tmp_num'][$i].'">
															</div>
						...
						<div class="cart_footer">
							<div class="cart_footer_box">
								...
								<button style="width:90%; border-radius:50px; height: 50px" onclick="location.href='cart.php'">去結帳</button>
							</div>
						</div>
					</div>
				</div>
